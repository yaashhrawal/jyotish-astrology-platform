...
export const EXT2: Dict = {
  ...
  'Back to charts': { en: 'Back to charts', hi: 'कुंडली पर वापस', sa: 'कुण्डलीं प्रति' },
  ...
  // ── Varshphal (annual / Tajika) ────────────────────────────────────
  'Timeline':       { en: 'Timeline',       hi: 'समयरेखा',    sa: 'कालक्रमः' },
  'Advanced':       { en: 'Advanced',       hi: 'विस्तृत',    sa: 'विस्तृतम्' },
  'Varshphal':      { en: 'Varshphal',      hi: 'वर्षफल',     sa: 'वर्षफलम्' },
  'Varshaphal':     { en: 'Varshaphal',     hi: 'वर्षफल',     sa: 'वर्षफलम्' },
  'Varshphal (Year)': { en: 'Varshphal (Year)', hi: 'वर्षफल (वर्ष)', sa: 'वर्षफलम्' },
  'Varshesh':       { en: 'Varshesh',       hi: 'वर्षेश',     sa: 'वर्षेशः' },
  'Mudda Dasha':    { en: 'Mudda Dasha',    hi: 'मुद्दा दशा', sa: 'मुद्दादशा' },
  'Year Timeline':  { en: 'Year Timeline',  hi: 'वर्ष समयरेखा', sa: 'वर्षकालक्रमः' },
  'NOW':            { en: 'NOW',            hi: 'अभी',        sa: 'अधुना' },
  'Office':         { en: 'Office',         hi: 'पद',         sa: 'पदम्' },
  'Kshetra':        { en: 'Kshetra',        hi: 'क्षेत्र',    sa: 'क्षेत्रम्' },
  'Uchcha':         { en: 'Uchcha',         hi: 'उच्च',       sa: 'उच्चम्' },
  'Hadda':          { en: 'Hadda',          hi: 'हद्दा',      sa: 'हद्दा' },
  'Drekkana':       { en: 'Drekkana',       hi: 'द्रेष्काण',  sa: 'द्रेष्काणम्' },
  'Navamsa':        { en: 'Navamsa',        hi: 'नवांश',      sa: 'नवांशः' },
  'Total':          { en: 'Total',          hi: 'कुल',        sa: 'योगः' },
  'Day birth':      { en: 'Day birth',      hi: 'दिन जन्म',   sa: 'दिवाजन्म' },
  'Night birth':    { en: 'Night birth',    hi: 'रात्रि जन्म', sa: 'रात्रिजन्म' },
  'Janma Lagnesh (natal)': { en: 'Janma Lagnesh (natal)', hi: 'जन्म लग्नेश', sa: 'जन्मलग्नेशः' },
  'Varsha Lagnesh': { en: 'Varsha Lagnesh', hi: 'वर्ष लग्नेश', sa: 'वर्षलग्नेशः' },
  'Muntha lord':    { en: 'Muntha lord',    hi: 'मुंथा स्वामी', sa: 'मुन्थेशः' },
  'Tri-rashi pati': { en: 'Tri-rashi pati', hi: 'त्रिराशि पति', sa: 'त्रिराशिपतिः' },
  'Dina-ratri pati':{ en: 'Dina-ratri pati',hi: 'दिन-रात्रि पति', sa: 'दिनरात्रिपतिः' },
  'strongest of 5 office-bearers by Panchavargeeya Bala': { en: 'strongest of 5 office-bearers by Panchavargeeya Bala', hi: 'पंचवर्गीय बल में 5 अधिकारियों में सर्वबली', sa: 'पञ्चवर्गीयबले पञ्चाधिकारिषु बलिष्ठः' },
  'Varsha-Vimshottari · 120 yrs compressed to one solar year': { en: 'Varsha-Vimshottari · 120 yrs compressed to one solar year', hi: 'वर्ष-विंशोत्तरी · 120 वर्ष एक सौर वर्ष में संकुचित', sa: 'वर्ष-विंशोत्तरी · विंशत्यधिकशतवर्षाणि एकस्मिन् सौरवर्षे' },
  'Varshesh rules the year. Its dignity, house & aspects color the whole annual chart.': { en: 'Varshesh rules the year. Its dignity, house & aspects color the whole annual chart.', hi: 'वर्षेश पूरे वर्ष का स्वामी है। उसकी अवस्था, भाव व दृष्टि पूरे वार्षिक चक्र को प्रभावित करती है।', sa: 'वर्षेशः सम्पूर्णवर्षस्य स्वामी। तस्य अवस्था भावः दृष्टिश्च समग्रं वार्षिकचक्रं प्रभावयति।' },
}
